...
const TempContents = () => {
    ...
    const openAddGroup = () => { addGroupRef.current.openDialog() }
    const openJoinGroup = () => { joinGroupRef.current.openDialog() }


    return (
        <div className="temp-contents-area">
            <div className="title-wrap"><h2>Nurse on Duty</h2></div>
            <div className="group-area">
                ...
                <div className="group-wrap" >
                    <img src={""} alt="join group" onClick={openJoinGroup} /> {/* 여기에 이미지 넣어주세요 */}
                    <label>그룹 참여</label>
                </div>
            </div>
